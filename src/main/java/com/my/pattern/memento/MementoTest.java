...
public class MementoTest {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(originator.getStateFromMemento(careTaker.get(2)));
        System.out.println(originator.getStateFromMemento(careTaker.getCurrent()));
        System.out.println(careTaker.mementos);
    }
}
